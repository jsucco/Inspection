...
Namespace core
    ...
    Public Class SPC_InspectionInput
        ...
        Public Function InsertDefect(ByVal id As String, ByVal text As String, ByVal JsonString As String, ByVal ButtonTemplateId As String, ByVal InspectionJobSummaryId As Integer, ByVal InspectionId As Integer, ByVal WeaverShiftIdVal As Integer, ByVal AsyncFlag As Boolean) As String
        ...
        Private Function InsertJob(ByVal jsobj As InspectionJobSummary) As Int64
            Try
                Using db As New Inspection_Entities()
                    db.InspectionJobSummaries.Add(jsobj)
                    db.SaveChanges()
                End Using
            Catch ex As Exception
                Elmah.ErrorSignal.FromCurrentContext().Raise(ex)
