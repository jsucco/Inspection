<%@ WebHandler Language="VB" Class="core.MainGrid_SubgridLoad" Debug="True" WarningLevel="0" %>
...
Namespace core
    ...
    Public Class MainGridSubgrid_Load : Implements IHttpHandler, IRequiresSessionState
