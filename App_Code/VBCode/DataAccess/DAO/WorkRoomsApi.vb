...
Namespace core
    ...
    Public Class WorkRoomsApi
        ...
        Private Shared Async Function GetCached(CID As String) As Threading.Tasks.Task(Of MethodResponse)
            Dim address As String = GetAPIBaseUrl() + "/api/WorkRooms/" + CID
        ...
        Public Shared Function GetAPIBaseUrl() As String
            If ConfigurationManager.AppSettings("InspectServicesBaseUrl") Is Nothing Then
                Throw New Exception("Inspect Services Base Url Not Present")
            End If
            Return ConfigurationManager.AppSettings("InspectServicesBaseUrl")
        End Function
