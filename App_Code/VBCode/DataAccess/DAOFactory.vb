...
Namespace core
    ...
    Public Class DAOFactory
        ...
        Public Function GetReader(ByVal sqlstring As String) As Boolean
            ...
            Try
                Using con As New SqlConnection(dl.CtxConnectionString)
                    ...
                    Dim cmd As New SqlCommand(sqlstring, coreConnection)
            ...
            'Try
            '    coreConnection = New SqlConnection(dl.CtxConnectionString)
            '    coreConnection.Open()
        ...
        Public Function getMaintFlag(ByVal sqlstring As String, ByVal PassCID As Integer) As List(Of MaintFlagMS)

            Dim readerlist As New List(Of MaintFlagMS)()
            Dim dictionary As New Dictionary(Of String, Object)
            Dim fieldList As List(Of ClassFieldInfo)

            fieldList = GetClassFieldTypes("core.MaintFlagMS")
                    ...
                    While coreReader.Read
                        ...
                        Try
                            If dictionary.Count > 0 Then
                                readerlist.Add(New MaintFlagMS With {.MM_Id = Convert.ToInt16(dictionary.Item("MM_Id")), .MM_Name = Convert.ToString(dictionary.Item("MM_Name")), .MT_Name = Convert.ToString(dictionary.Item("MT_Name")), .MS_Maint_Time_Alotted = Convert.ToInt16(dictionary.Item("MS_Maint_Time_Alotted")), .MS_Main_Time_Required = Convert.ToInt16(dictionary.Item("MS_Main_Time_Required")), .MS_Frequency = Convert.ToInt16(dictionary.Item("MS_Frequency")), .MS_Last_Main_Date = Convert.ToString(dictionary.Item("MS_Last_Main_Date")), .MS_Next_Main_Date = Convert.ToString(dictionary.Item("MS_Next_Main_Date")), .MS_Maint_Code = Convert.ToInt16(dictionary.Item("MS_Maint_Code")), .MS_Workorder = Convert.ToString(dictionary.Item("MS_Workorder")), .MS_Main_Comp_Date = Convert.ToString(dictionary.Item("MS_Main_Comp_Date")), .EMP_ID = Convert.ToUInt16(dictionary.Item("EMP_ID")), .MS_Total_Machine_Downtime = Convert.ToInt16(dictionary.Item("MS_Total_Machine_Downtime")), .MS_Machine_Hours = Convert.ToInt64(dictionary.Item("MS_Machine_Hours")), .MS_Unscheduled_Reason = Convert.ToString(dictionary.Item("MS_Unscheduled_Reason")), .MS_Notes = Convert.ToString(dictionary.Item("MS_Notes")), .RowNumber = Convert.ToInt16(dictionary.Item("RowNumber")), .MT_Id = Convert.ToInt16(dictionary.Item("MT_Id")), .EMP_First_Name = Convert.ToString(dictionary.Item("EMP_First_Name")), .MM_Number = Convert.ToInt16(dictionary.Item("MM_Number")), .MFB_Id = Convert.ToInt32(dictionary.Item("MFB_Id"))})
                            Else
                                readerlist.Add(New MaintFlagMS With {.MM_Id = Convert.ToInt16(record(0)), .MM_Name = Convert.ToString(record(1)), .MT_Name = Convert.ToString(record(2)), .MS_Maint_Time_Alotted = Convert.ToInt16(record(3)), .MS_Main_Time_Required = Convert.ToInt16(record(4)), .MS_Frequency = Convert.ToInt16(record(5)), .MS_Last_Main_Date = Convert.ToString(record(6)), .MS_Next_Main_Date = Convert.ToString(record(7)), .MS_Maint_Code = Convert.ToInt16(record(8)), .MS_Workorder = Convert.ToString(record(9)), .MS_Main_Comp_Date = Convert.ToString(record(10)), .EMP_ID = Convert.ToUInt16(record(11)), .MS_Total_Machine_Downtime = Convert.ToInt16(record(12)), .MS_Machine_Hours = Convert.ToInt64(record(13)), .MS_Unscheduled_Reason = Convert.ToString(record(14)), .MS_Notes = Convert.ToString(record(15)), .RowNumber = Convert.ToInt16(record(16)), .MT_Id = Convert.ToInt16(record(17)), .EMP_First_Name = Convert.ToString(record(18)), .MM_Number = Convert.ToInt16(record(19)), .MFB_Id = Convert.ToInt32(record(20))})
                            End If
        ...
        Public Function getMaintBoard(ByVal sqlstring As String) As List(Of MaintBoard)
            Dim readerlist As New List(Of MaintBoard)()
            Using con As New SqlConnection(dl.CtxConnectionString)
                con.Open()
                Dim cmd As New SqlCommand(sqlstring, con)
                coreReader = cmd.ExecuteReader(CommandBehavior.CloseConnection)
                ...
                If coreReader.FieldCount > 0 Then
                    While coreReader.Read
                        record = CType(coreReader, IDataRecord)
                        Try
                            readerlist.Add(New MaintBoard With {.MM_Id = Convert.ToInt32(record(0)), .MT_Id = Convert.ToInt32(record(1)), .MS_Next_Main_Date = Convert.ToDateTime(record(2)), .MM_Number = Convert.ToInt16(record(3)), .MS_Unscheduled_Reason = Convert.ToString(record(4)), .MMName = Convert.ToString(record(5)), .MT_Description = Convert.ToString(record(6)), .WorkOrder = Convert.ToString(record(7)), .MS_Id = Convert.ToInt16(record(8)), .MS_WOCreate_Timestamp = Convert.ToString(record(9)), .MS_WOClosed_Timestamp = Convert.ToString(record(10)), .MS_Notes = Convert.ToString(record(11))})
                        Catch ex As Exception
        ...
        End Function
        Public Function getMaintBoardMobile(ByVal sqlstring As String) As List(Of MaintBoardMobile)
            Dim readerlist As New List(Of MaintBoardMobile)()
            ...
            Using con As New SqlConnection(dl.CtxConnectionString)
                ...
                If coreReader.FieldCount > 0 Then
                    While coreReader.Read
                        record = CType(coreReader, IDataRecord)
                        Try
                            'readerlist.Add(New MaintBoardMobile With {.MT_Description = Convert.ToString(record(0)), .MS_Unscheduled_Reason = Convert.ToString(record(1)), .MMName = Convert.ToString(record(2)), .WorkOrder = Convert.ToString(record(3)), .MS_Id = Convert.ToInt16(record(4)), .MS_WOCreate_Timestamp = Convert.ToString(record(5)), .MS_WOClosed_Timestamp = Convert.ToString(record(6))})
                        Catch ex As Exception
        ...
        End Function
        Public Function getMaintBoardPC(ByVal sqlstring As String, ByVal PassCID As Integer) As List(Of FlagBoard.MaintBoardPC)
            Dim readerlist As New List(Of FlagBoard.MaintBoardPC)()
            Dim dictionary As New Dictionary(Of String, Object)
            Dim fieldList As List(Of ClassFieldInfo)

            fieldList = GetClassFieldTypes("core.FlagBoard.MaintBoardPC")
            ...
            Using con As New SqlConnection(dl.SetCtxConnectionString(PassCID))
                ...
                If coreReader.FieldCount > 0 Then
                    While coreReader.Read
                        ...
                        dictionary = ProcessRecordSet(record, fieldList)
                        Try
                            If dictionary.Count > 0 And IsNothing(dictionary) = False Then
                                readerlist.Add(New FlagBoard.MaintBoardPC With {.MT_Description = Convert.ToString(dictionary.Item("MT_Description")), .MT_Id = Convert.ToInt32(dictionary.Item("MT_Id")), .MS_Unscheduled_Reason = Convert.ToString(dictionary.Item("MS_Unscheduled_Reason")), .MMName = Convert.ToString(dictionary.Item("MM_Name")), .WorkOrder = Convert.ToString(dictionary.Item("MS_Workorder")), .MS_Id = Convert.ToInt64(dictionary.Item("MS_Id")), .MFB_Id = Convert.ToInt32(dictionary.Item("MFB_Id")), .MS_WOCreate_Timestamp = Convert.ToString(dictionary.Item("MS_WOCreate_Timestamp")), .MS_WOClosed_Timestamp = Convert.ToString(dictionary.Item("MS_WOClosed_Timestamp")), .MM_Number = Convert.ToInt32(dictionary.Item("MM_Number")), .MS_Notes = Convert.ToString(dictionary.Item("MS_Notes"))})
                            Else
                                readerlist.Add(New FlagBoard.MaintBoardPC With {.MT_Description = Convert.ToString(record(0)), .MT_Id = Convert.ToInt32(record(1)), .MS_Unscheduled_Reason = Convert.ToString(record(2)), .MMName = Convert.ToString(record(3)), .WorkOrder = Convert.ToString(record(4)), .MS_Id = Convert.ToInt64(record(5)), .MFB_Id = Convert.ToInt32(record(6)), .MS_WOCreate_Timestamp = Convert.ToString(record(7)), .MS_WOClosed_Timestamp = Convert.ToString(record(8)), .MM_Number = Convert.ToInt32(record(9)), .MS_Notes = Convert.ToString(record(10))})
                            End If
                        Catch ex As Exception
        ...
        Public Function getComboBox(ByVal sqlstring As String, Optional ByVal CID As Integer = 0) As List(Of ComboBox)
            Dim readerlist As New List(Of ComboBox)()
            ...
            Using con As New SqlConnection(dl.CtxConnectionString)
                ...
                If coreReader.FieldCount > 0 Then
                    While coreReader.Read
                        record = CType(coreReader, IDataRecord)
                        readerlist.Add(New ComboBox With {.label = Convert.ToString(record(1)), .value = Convert.ToInt16(record(0))})
        ...
        Public Function getSelector2_Ctx(ByVal sqlstring As String, ByVal CID As Integer) As List(Of selector2array)
            Dim readerlist As New List(Of selector2array)()

            Using con As New SqlConnection(dl.SetCtxConnectionString(CID))
                con.Open()
                Dim cmd As New SqlCommand(sqlstring, con)
                coreReader = cmd.ExecuteReader(CommandBehavior.CloseConnection)
        ...
        Public Function getEquipment(ByVal sqlstring As String) As List(Of Equipment)
            Dim readerlist As New List(Of Equipment)()
            ...
            Using con As New SqlConnection(dl.CtxConnectionString)
                ...
                If coreReader.FieldCount > 0 Then
                    While coreReader.Read
                        record = CType(coreReader, IDataRecord)
                        Try
                            readerlist.Add(New Equipment With {.items = Convert.ToString(record(0))})
                        Catch ex As Exception
