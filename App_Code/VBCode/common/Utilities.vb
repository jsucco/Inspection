...
Namespace core
    ...
    Public Class Utilities
        ...
        Function FillDataSet(ByRef rptDS As DataSet, ByVal TableName As String, ByVal SQL As String, Optional ByVal PassCID As Integer = 0) As Boolean
        ...
        Public Function DetectDeviceType(ByVal UserAgentString As String) As Boolean
            ...
            If SystemString.Length > 0 Then
                varstring = SystemString(1)
                SystemArray = varstring.Split(sysset)
