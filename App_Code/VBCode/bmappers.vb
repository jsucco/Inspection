...
Namespace core
    ...
    Public Class BMappers(Of t As {Class, New})
        ...
        Public Function GetCtxObject(ByVal Sql As String, Optional ByVal CID As Integer = 0) As List(Of t)
        ...
        Public Function InsertCtxObject(ByVal sql As String, Optional ByVal obj As t = Nothing, Optional ByVal CID As Integer = 0) As Boolean
            Dim returnint As Integer = 0
            Dim cnt As Integer = 0
            'If ParaStringArray.Length > 0 Then
            Using conn As New SqlConnection(dl.SetCtxConnectionString(CID))
                Dim cmd As New SqlCommand(sql, conn)
                If IsNothing(obj) = False Then
                    Properties = obj.GetType().GetProperties()
                    Dim ParaStringArray As String() = GetQueryStringParam(sql)
