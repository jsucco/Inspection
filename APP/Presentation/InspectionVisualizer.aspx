...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div style="position:absolute; left:50px; width:75%; height:150px;">
        <div id="LcustomersSlider" style="top: 10px; left: 100px; position:relative; height: 150px; "> 
...
<%--        <div id="Locations" class="owl-carousel" style="position: absolute; left: 100px;">
    ...
    <div style="position:absolute; z-index:1000; left: 95.5%;" id="backdiv">
        <a id="hideFilters" style="position:absolute; top:94px;border-style: outset;"></a>
        <a id="showFilters" style="position:absolute; display: none; top:94px;border-style: outset;"></a>
    </div>
    <div id="FilterDiv" style="position:relative; left: -10px; top: 130px; width:100%; height:100px;background-color: rgba(240,240,240,1); border: 1px solid #ccc; overflow: hidden;">
    ...
    <div id="reportOptions" style="left: 50%; display: none; Z-INDEX: 1000;">
        ...
        <div>
            ...
            <div class="tile-options" id="divCustomerReport" onclick="">
            ...
            <div class="tile-options" id="divExcel">
        ...
        <div id="tabs" style="position:relative; display:none; Z-INDEX: 104; top: 130px; margin:auto; width: 100%; height: 100%; left: -10px;" >
        <ul>
...
<%--        <script src="../../Scripts/owl/owl.carousel.js" type="text/javascript"></script>
    <script src="../../Scripts/owl/owl.carousel.min.js" type="text/javascript"></script>
    <script src="../../Scripts/owl/owl.animate.js" type="text/javascript"></script>--%>
    <script src="../../Scripts/Gcharts/jsapi.js"></script>
<%--    <script src="../../Scripts/owl/owl.autoplay.js" type="text/javascript"></script>--%>
    ...
    <script type="text/javascript">
        ...
        var carousel = {
            ...
            EnlargeMe: function (ImageId) { 
                ...
                console.log('filtered', DefectPictureArrayF);
                console.log('orig', DefectPictureArray);
                console.log('used', UsedArray);
                Holder.toggle(); 
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data) { 
                            ...
                            console.log('DHULineChart',data);
                            
                            var dataarr = data.split('%%%');
                            console.log('DHULineChart_split',dataarr);
                            if (dataarr.length == 2) {
