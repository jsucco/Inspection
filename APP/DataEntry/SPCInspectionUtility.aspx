            ...
            buttons: {
                ...
                'Close': function () {
                    ...
                    $.each(idarray, function (index, value) {
                        ...
                        var nameLength = $("#" + value + "_Name").val().length;


                        if (find != -1  && nameLength > 1) { 
                ...
                'Add': function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (existsflag == false) { 
                                var LineType = $("#LineType_pop").val();
                                dbtrans.InsertTemplate(EnteredName, LineType)
                                if (EnteredName) {
                                    $('#ActiveTemplateTitle').val(EnteredName)
                                }
                            } else { 
                        ...
                        error: function (a, b, c) {
                            console.log(a);
                            alert("Error Inserting TemplateName:" + a); 
       ...
       //     }
        ...
        RenderDefectTypesGrid: function () { 
            ...
            $("#DefectTypesgrid").jqGrid({
                ...
                colNames: ['ButtonId', 'DefectCode', 'Name', 'Hide'],
                colModel: [
