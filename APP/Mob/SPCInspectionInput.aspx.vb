...
Namespace core
    ...
    Partial Class APP_DataEntry_SPCInspectionInput
            ...
            Else
                Try
                    ...
                    If IsNothing(aqlobj) = False And aqlobj.count > 0 Then
                        AQL = aqlobj.Item("LastAQLCompleted")
                    End If
                    SetLastUserInputs()
        ...
        Private Function setInspectionLocation() As Boolean
            ...
            Else
                If CIDCookie.Count > 0 Then
                    ...
                    HasCID = True
                ElseIf IsNothing(Request.QueryString("CID_Info")) = False And IsNumeric(Request.QueryString("CID_Info")) = True Then
                    CID = CType(Request.QueryString("CID_Info"), Integer).ToString()
                    CIDnum = Convert.ToInt32(Request.QueryString("CID_Info"))
                    HasCID = True
        ...
        Protected Sub COnfirm2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Confirm.Click, ConfirmRoll.Click
            ...
            Try
                Using _db As New Inspection_Entities
                    ...
                    If IsNothing(curijs) = False And curijs.WOQuantity > 0 Then
        ...
        Private Sub SetOpenRollinfo(ByVal ijsid As Integer)
            ...
            Dim sql As String
            sql = "SELECT JobNumber, WOQuantity, AQL_Level, Standard FROM InspectionJobSummary WHERE id = " & ijsid.ToString()
