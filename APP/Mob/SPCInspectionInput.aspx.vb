    ...
    Partial Class APP_DataEntry_SPCInspectionInput
        ...
        Private Function setInspectionLocation() As Boolean
            ...
            If IstestMode = True Then
                ...
                HasCID = True
            Else
                If Not CIDCookie Is Nothing Then
                    If CIDCookie.Trim().Length < 3 Then
                ...
                End If
233:
                If IsNothing(Request.QueryString("CID_Info")) = False And IsNumeric(Request.QueryString("CID_Info")) = True Then
